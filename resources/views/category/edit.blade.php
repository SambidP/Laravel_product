                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="display_name" class="form-control border-0 shadow-sm"
                                            value="{{ $category->display_name }}" placeholder="Enter display name" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" class="form-control border-0 shadow-sm"
                                            value="{{ $category->code }}" placeholder="Enter category code" />
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Change Image</label>
                                        <input type="file" name="image_path" class="form-control border-0 shadow-sm"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        @if ($category->image_path)
                                            <img src="{{ asset($category->image_path) }}" class="img-thumbnail"
                                                width="150">
                                        @else
