                ...
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-header bg-warning text-white">
                        <h4 class="mb-0">Edit Product
                            <a href="{{ route('product.index') }}?category_id={{ $product->category_id }}"
                                class="btn btn-outline-light float-end">Back</a>
                        </h4>
                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="display_name" class="form-control"
                                            value="{{ $product->display_name }}" required />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            @if ($product->image_path)
                                                <img src="{{ asset($product->image_path) }}" class="img-thumbnail"
                                                    width="150">
                                            @else
