                    ...
                    <div class="card shadow-lg border-0 rounded-3">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0">Products
                                <a href="{{ route('category.index') }}" class="btn btn-outline-light float-end ms-2">Back to
                                    Categories</a>
                                <a href="{{ route('product.create', ['category_id' => $category_id]) }}"
                                    class="btn btn-outline-light float-end">Add a Product</a>
                            </h4>
                        </div>
                        <div class="card-body p-4">
